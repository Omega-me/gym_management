 ...
 * @param opts
 */
export const prefetchGymClient = async <TData,>(opts: { queryClient: QueryClient; config?: IQueryOpts<TData> }) => {
  const route = eApiRoutes.GYM_CLIENT;
 ...
 * @returns
 */
export const useGymClientQuery = <TData,>(opts?: IQueryOpts<TData>) => {
 ...
 * @param opts
 */
export const useGymClientMutation = <TData,>(opts?: IMutationOpts<TData>) => {
  const queryClient = useQueryClient();
  const route = eApiRoutes.GYM_CLIENT;
