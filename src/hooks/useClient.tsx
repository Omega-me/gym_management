 ...
 * @param opts
 */
export const prefetchClient = async <TData,>(opts: { queryClient: QueryClient; config?: IQueryOpts<TData> }) => {
 ...
 * @returns
 */
export const useClientQuery = <TData,>(opts?: IQueryOpts<TData>) => {
 ...
 * @param opts
 */
export const useClientMutation = <TData,>(opts?: IMutationOpts<TData>) => {
  const queryClient = useQueryClient();
  const route = eApiRoutes.CLIENTS;
