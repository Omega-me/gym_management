 ...
 * @param opts
 */
export const prefetchEmplyee = async <TData,>(opts: { queryClient: QueryClient; config?: IQueryOpts<TData> }) => {
  const route = eApiRoutes.EMPLOYEES;
 ...
 * @returns
 */
export const useEmplyeeQuery = <TData,>(opts?: IQueryOpts<TData>) => {
 ...
 * @param opts
 */
export const useEmplyeeMutation = <TData,>(opts?: IMutationOpts<TData>) => {
  const queryClient = useQueryClient();
  const route = eApiRoutes.EMPLOYEES;
