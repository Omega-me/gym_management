 ...
 * @param opts
 */
export const prefetchManager = async <TData,>(opts: { queryClient: QueryClient; config?: IQueryOpts<TData> }) => {
  const route = eApiRoutes.MANAGERS;
 ...
 * @returns
 */
export const useManagerQuery = <TData,>(opts?: IQueryOpts<TData>) => {
 ...
 * @param opts
 */
export const useManagerMutation = <TData,>(opts?: IMutationOpts<TData>) => {
  const queryClient = useQueryClient();
  const route = eApiRoutes.MANAGERS;
