 ...
 * @param opts
 */
export const prefetchMembership = async <TData,>(opts: { queryClient: QueryClient; config?: IQueryOpts<TData> }) => {
  const route = eApiRoutes.MEMBERSHIPS;
 ...
 * @returns
 */
export const useMembershipQuery = <TData,>(opts?: IQueryOpts<TData>) => {
 ...
 * @param opts
 */
export const useMembershipMutation = <TData,>(opts?: IMutationOpts<TData>) => {
  const queryClient = useQueryClient();
  const route = eApiRoutes.MEMBERSHIPS;
